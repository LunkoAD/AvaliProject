...
public class FirelanceItemRenderer extends GeoItemRenderer<FirelanceItem> {
    public FirelanceItemRenderer() {
        super(new FirelanceItemModel());
    }

    @Override
    public RenderType getRenderType(FirelanceItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    protected FirelanceItem animatable;
    ...
    @Override
    public void renderRecursively(PoseStack stack, FirelanceItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
    ...
    @Override
    public ResourceLocation getTextureLocation(FirelanceItem instance) {
