...
public class NovaItemRenderer extends GeoItemRenderer<NovaItem> {
    public NovaItemRenderer() {
        super(new NovaItemModel());
    }

    @Override
    public RenderType getRenderType(NovaItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, NovaItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, NovaItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn,float red, float green, float blue, float alpha) {
    ...
    @Override
    public ResourceLocation getTextureLocation(NovaItem instance) {
