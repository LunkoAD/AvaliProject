...
public class QrcItemRenderer extends GeoItemRenderer<QrcItem> {
    public QrcItemRenderer() {
        super(new QrcItemModel());
    }

    @Override
    public RenderType getRenderType(QrcItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, QrcItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, QrcItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
    ...
    @Override
    public ResourceLocation getTextureLocation(QrcItem instance) {
