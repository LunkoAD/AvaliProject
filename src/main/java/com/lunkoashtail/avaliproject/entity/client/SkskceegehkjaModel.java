...
public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(138, 64).addBox(-4.5F, 0.0F, -1.0F, 8.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -18.0F, 0.0F, -1.309F, 0.0F, 0.0F));

    PartDefinition bone = Tail.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 11.0F));

    PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(116, 124).addBox(-5.0F, -2.0F, -1.0F, 10.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 2.0F, 1.0F, 0.1745F, 0.0F, 0.0F));

    PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(-0.5F, 2.0F, 14.0F));

    PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 106).addBox(-4.0F, -2.0F, -1.0F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.0F, 4.0F, 1.3963F, 0.0F, 0.0F));

    PartDefinition cube_r3 = bone2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 127).addBox(-6.0F, -2.0F, -1.0F, 11.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -3.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
    ...
    PartDefinition cube_r4 = LeftHorn.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(70, 88).addBox(0.0F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5411F, 1.0911F, -0.5534F));

    PartDefinition cube_r5 = LeftHorn.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(64, 76).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4856F, -4.183F, -0.7188F, -0.3832F, 1.1302F, -0.3773F));

    PartDefinition cube_r6 = LeftHorn.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(140, 147).addBox(-3.0F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2955F, -8.1242F, 0.1062F, -0.6711F, 1.0413F, -0.7018F));

    PartDefinition cube_r7 = LeftHorn.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(140, 140).addBox(-3.0F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7036F, -10.9971F, 2.7039F, -1.0237F, 0.7068F, -1.1521F));

    PartDefinition cube_r8 = LeftHorn.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(138, 110).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0305F, -10.3799F, 5.7219F, -1.1514F, 0.24F, -1.4232F));
    ...
    PartDefinition cube_r9 = RightHorn.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(70, 88).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5411F, -1.0911F, 0.5534F));

    PartDefinition cube_r10 = RightHorn.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(64, 76).mirror().addBox(0.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.4856F, -4.183F, -0.7188F, -0.3832F, -1.1302F, 0.3773F));

    PartDefinition cube_r11 = RightHorn.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(140, 147).mirror().addBox(0.0F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.2955F, -8.1242F, 0.1062F, -0.6711F, -1.0413F, 0.7018F));

    PartDefinition cube_r12 = RightHorn.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(140, 140).mirror().addBox(0.0F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.7036F, -10.9971F, 2.7039F, -1.0237F, -0.7068F, 1.1521F));

    PartDefinition cube_r13 = RightHorn.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(138, 110).mirror().addBox(-2.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0305F, -10.3799F, 5.7219F, -1.1514F, -0.24F, 1.4232F));
