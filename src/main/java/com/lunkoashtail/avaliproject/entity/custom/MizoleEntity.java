...
public class MizoleEntity extends TamableAnimal implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MizoleEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MizoleEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MizoleEntity.class, EntityDataSerializers.STRING);
    ...
    public MizoleEntity(EntityType<MizoleEntity> type, Level world) {
        super(type, world);
        xpReward = 2;
        setNoAi(false);
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(TEXTURE, "mizole");
    }
    ...
    protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
        ...
        this.spawnAtLocation(new ItemStack(Items.BONE, 1+looting));
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        MizoleEntity retval = ModEntities.MIZOLE.get().create(serverWorld);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(MizoleEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
