...
public class FemaleNevreanEntity extends Animal implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FemaleNevreanEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FemaleNevreanEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FemaleNevreanEntity.class, EntityDataSerializers.STRING);
    ...
    public FemaleNevreanEntity(EntityType<FemaleNevreanEntity> type, Level world) {
        super(type, world);
        xpReward = 0;
        setNoAi(false);
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(TEXTURE, "female_nevrean");
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        FemaleNevreanEntity retval = ModEntities.FEMALE_NEVREAN.get().create(serverWorld);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(FemaleNevreanEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
